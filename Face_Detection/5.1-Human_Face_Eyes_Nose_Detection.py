...
# Load human nose cascade file using cv2.CascadeClassifier built-in function
# cv2.CascadeClassifier(filename) 
...
# Check if human nose cascade file is loaded	
...
while True:
	...
	resize_frame = cv2.resize(capturing, None, fx=2.0, fy=2.0, 
    ...
    # Rectangles are drawn around nose using cv2.rectangle built-in function
    # cv2.rectangle(color_roi, (x1,y1), (x2,y2), color, thickness)
